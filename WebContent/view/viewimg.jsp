...
<c:url value="/static/js/viewimg.js" var="js"></c:url>
<script type="text/javascript" src="${js }"></script>
<c:url value="/static/css/viewimg.css" var="css"></c:url>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-9">
				...
				<div class="img-container">
					<img
						src="https://images.unsplash.com/photo-1509818477184-066c1c6b155a?ixlib=rb-0.3.5&q=85&fm=jpg&crop=entropy&cs=srgb&dl=hiren-sojitra-436196-unsplash.jpg&s=7c841a8474d291d8c5d3b77d246d78e8"
						alt="Picture">
				</div>
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			<div class="col-md-9 docs-buttons">
				...
				<div class="btn-group">
					<button class="btn btn-primary" data-method="crop" type="button"
						title="Crop">
						<span class="docs-tooltip" data-toggle="tooltip"
							title="$().cropper("crop")"> <span class="icon icon-ok"></span>
						</span>
					</button>
				...
				<div class="btn-group btn-group-crop">
					<button class="btn btn-primary" data-method="getCroppedCanvas"
						type="button">
						<span class="docs-tooltip" data-toggle="tooltip"
							title="$().cropper("getCroppedCanvas")"> Get Cropped
							Canvas </span>
					</button>
					<button class="btn btn-primary" data-method="getCroppedCanvas"
				...
				<button class="btn btn-primary" data-method="getData" data-option=""
					data-target="#putData" type="button">
					<span class="docs-tooltip" data-toggle="tooltip"
						title="$().cropper("getData")"> Get Data </span>
				</button>
				<button class="btn btn-primary" data-method="setData"
					data-target="#putData" type="button">
					<span class="docs-tooltip" data-toggle="tooltip"
						title="$().cropper("setData", data)"> Set Data </span>
				</button>
				<button class="btn btn-primary" data-method="getContainerData"
					data-option="" data-target="#putData" type="button">
					<span class="docs-tooltip" data-toggle="tooltip"
						title="$().cropper("getContainerData")"> Get Container Data
					</span>
				</button>
				...
				<button class="btn btn-primary" data-method="setCanvasData"
					data-target="#putData" type="button">
					<span class="docs-tooltip" data-toggle="tooltip"
						title="$().cropper("setCanvasData", data)"> Set Canvas Data
					</span>
				</button>
			...
			<div class="col-md-3 docs-toggles">
				...
				<div class="btn-group btn-group-justified" data-toggle="buttons">
					<label class="btn btn-primary active" data-method="setAspectRatio"
						...
						class="docs-tooltip" data-toggle="tooltip" title="$().cropper("setAspectRatio", 16 / 9)">
							16:9 </span>
						...
						class="docs-tooltip" data-toggle="tooltip" title="$().cropper("setAspectRatio", 4 / 3)">
							4:3 </span>
					</label> <label class="btn btn-primary" data-method="setAspectRatio"
						...
						data-toggle="tooltip" title="$().cropper("setAspectRatio", 1 / 1)">
							1:1 </span>
					</label> <label class="btn btn-primary" data-method="setAspectRatio"
						...
						class="docs-tooltip" data-toggle="tooltip" title="$().cropper("setAspectRatio", 2 / 3)">
							2:3 </span>
					</label> <label class="btn btn-primary" data-method="setAspectRatio"
						data-option="NaN" title="Set Aspect Ratio"> <input
						class="sr-only" id="aspestRatio5" name="aspestRatio" value="NaN"
						type="radio"> <span class="docs-tooltip"
						data-toggle="tooltip" title="$().cropper("setAspectRatio", NaN)">
							Free </span>
					</label>
				</div>
		...
		<h2>
			Here is the <a href="http://fengyuanchen.github.io/cropper/"
				target="_blank">Original Source</a>
		</h2>
	</div>
	<!-- Alert -->
